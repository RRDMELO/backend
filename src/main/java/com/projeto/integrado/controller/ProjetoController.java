...
public class ProjetoController {
	...
	@GetMapping
	public ResponseEntity<List<Projeto>> getAll(@RequestParam(required = false) String descricao){
		List<Projeto> projetos;
		if (descricao != null && !descricao.isEmpty()) {
			projetos = projetoService.findByProjetoDescricaoContaining(descricao);
		} else {
			projetos = projetoService.getAll();
		}
